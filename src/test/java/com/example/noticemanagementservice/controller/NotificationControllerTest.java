...
public class NotificationControllerTest {
    ...
    public void registerNotice() throws Exception {
        ...
        Mockito.when(noticeManageService.createNotice(noticeDto)).thenReturn(notice);
    ...
    public void testGetAllNotice() throws Exception {
        ...
        when(noticeManageService.getAllNotice(Mockito.anyInt(), Mockito.anyInt())).thenReturn(noticePage);
    ...
    public void testGetNotice() throws Exception {
        ...
        when(noticeManageService.getDetails(any())).thenReturn(noticeDto);
    ...
    public void getNoticeByUser() throws Exception {
        List<Notice> notice = new ArrayList<>();
        PageImpl<Notice> noticePage = new PageImpl<>(notice);
        when(noticeManageService.getNoticesByUser(Mockito.anyInt(), Mockito.anyInt(), Mockito.anyString())).thenReturn(noticePage);
